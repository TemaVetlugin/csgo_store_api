...
class SendFailedTransactionMailJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        $transactionMailService->sendFailedTransactionMailToUser($transaction->getOrder()->getUser(), $transaction);
    }
